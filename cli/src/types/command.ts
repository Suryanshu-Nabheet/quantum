 ...
 * API-key users and direct Console API key users (api.anthropic.com),
 * but hides it from Bedrock/Vertex/Foundry users and custom base URL users.
 */
export type CommandAvailability =
  // provider auth subscriber (Pro/Max/Team/Enterprise via remote)
  | 'claude-ai'
  // Console API key user (direct api.anthropic.com, not via provider auth)
  | 'console'
