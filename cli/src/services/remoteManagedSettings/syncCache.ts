 ...
 *   QUANTUM_OAUTH_TOKEN / FD, or keychain tokens missing metadata): Eligible —
...
export function isRemoteManagedSettingsEligible(): boolean {
  ...
  // Check OAuth first: most the consumer product users have no API key in the keychain.
  ...
  // Externally-injected tokens (CCD via QUANTUM_OAUTH_TOKEN, CCR via
  // QUANTUM_OAUTH_TOKEN_FILE_DESCRIPTOR, Agent SDK, CI) carry no
  // subscriptionType metadata — getQuantumOAuthTokens() constructs them with
