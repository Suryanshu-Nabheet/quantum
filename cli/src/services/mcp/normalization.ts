...
// the consumer product server names are prefixed with this string
const CLAUDEAI_SERVER_PREFIX = 'connector '

/**
 * Normalize server names to be compatible with the API pattern ^[a-zA-Z0-9_-]{1,64}$
 * Replaces any invalid characters (including dots and spaces) with underscores.
 *
 * For remote servers (names starting with "connector "), also collapses
