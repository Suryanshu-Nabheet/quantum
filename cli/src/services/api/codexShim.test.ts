...
function createTempAuthJson(payload: Record<string, unknown>): string {
  const dir = mkdtempSync(join(tmpdir(), 'quantum-codex-'))
  tempDirs.push(dir)
...
describe('Codex request translation', () => {
  ...
  test('recovers Codex web search text and sources from sparse completed response', () => {
        ...
        output: [
          {
            ...
            sources: [
              {
                title: 'Quantum repo',
                url: 'https://github.com/example/quantum',
              },
            ],
          },
          {
            ...
            content: [
              {
                type: 'text',
                text: 'Quantum is available on GitHub.',
                sources: [
                  {
                    title: 'Docs',
                    url: 'https://docs.example.com/quantum',
                  },
                ],
              },
            ],
    ...
    expect(output.results).toEqual([
      'Quantum is available on GitHub.',
      {
            ...
            content: [
              {
                ...
                sources: [
                  { title: 'Docs', url: 'https://docs.example.com/quantum' },
                ],
              },
            ],
          },
