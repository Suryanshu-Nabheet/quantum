 ...
 *
 * QUANTUM_BRIEF env var force-grants entitlement for dev/testing —
...
export function isBriefEntitled(): boolean {
  ...
  return false || false
    ? getKairosActive() ||
        isEnvTruthy(process.env.QUANTUM_BRIEF) ||
 ...
 *   - QUANTUM_BRIEF env var (maybeActivateBrief — dev/testing bypass)
