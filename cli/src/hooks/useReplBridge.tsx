 ...
 *
 * Inbound messages from the remote client are injected into the REPL via queuedCommands.
 */
    ...
    if (false) {
      ...
      void (async () => {
        try {
          ...
          // Assistant mode: perpetual bridge session — the remote client shows one
          ...
          // When a user message arrives from the remote client, inject it into the REPL.
