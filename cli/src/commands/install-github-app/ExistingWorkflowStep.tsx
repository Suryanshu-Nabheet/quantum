...
export function ExistingWorkflowStep(t0) {
  ...
  if ($[8] === Symbol.for("react.memo_cache_sentinel")) {
    t6 = <Box flexDirection="column" marginBottom={1}><Text>A Quantum workflow file already exists at{" "}<Text color="claude">.github/workflows/quantum.yml</Text></Text><Text dimColor={true}>What would you like to do?</Text></Box>;
    $[8] = t6;
  } else {
    t6 = $[8];
  }
  ...
  if ($[12] === Symbol.for("react.memo_cache_sentinel")) {
    t8 = <Box marginTop={1}><Text dimColor={true}>View the latest workflow template at:{" "}<Text color="claude">https://github.com/Suryanshu-Nabheet/Quantum/blob/main/cli/README.md</Text></Text></Box>;
    $[12] = t8;
  } else {
    t8 = $[12];
  }
