...
// user triggers, so the description carries "Quantum CLI on the web" + URL.
const CCR_TERMS_URL = 'https://github.com/Suryanshu-Nabheet/Quantum/blob/main/cli/README.md'
...
const ultrareview: Command = {
  type: 'local-jsx',
  name: 'ultrareview',
  description: `~10–20 min · Finds and verifies bugs in your branch. Runs in Quantum on the web. See ${CCR_TERMS_URL}`,
