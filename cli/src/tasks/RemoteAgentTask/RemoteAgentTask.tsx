...
export function formatPreconditionError(error: BackgroundRemoteSessionPrecondition): string {
  switch (error.type) {
    case 'not_logged_in':
      return 'Remote sessions are not available in Quantum CLI. Use an API key or provider profile.';
    case 'no_remote_environment':
      return 'No cloud environment available. Set one up at https://github.com/Suryanshu-Nabheet/Quantum/onboarding?magic=env-setup';
    ...
    case 'github_app_not_installed':
      return 'The Quantum GitHub app must be installed on this repository first.\nhttps://github.com/apps/claude/installations/new';
    case 'policy_blocked':
...
/**
 * RemoteAgentTask - Handles remote the consumer product session execution.
 *
