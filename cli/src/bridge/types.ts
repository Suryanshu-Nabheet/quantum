...
export const BRIDGE_LOGIN_INSTRUCTION =
  'Remote Control is not available in Quantum CLI.'

/** Full error printed when `quantum remote-control` is run without auth. */
 ...
 * `metadata.worker_type` at environment registration so the remote client can filter
