...
import type { ExternalClaudeMdInclude } from '../utils/projectMemory.js';
...
export function QuantumMdExternalIncludesDialog(t0: Props) {
  const $ = _c(18);
  const {
    onDone,
    isStandaloneDialog,
  ...
  if ($[8] === Symbol.for("react.memo_cache_sentinel")) {
    t8 = <Text dimColor={true}>Important: Only use Quantum CLI with files you trust. Accessing untrusted files may pose security risks{" "}<Link url="https://github.com/Suryanshu-Nabheet/Quantum/blob/main/cli/README.md" />{" "}</Text>;
    $[8] = t8;
  } else {
    t8 = $[8];
  }
