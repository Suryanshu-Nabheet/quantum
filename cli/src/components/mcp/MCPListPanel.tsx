...
export function MCPListPanel(t0) {
  ...
  if ($[60] !== hasFailedClients) {
    t26 = hasFailedClients && <Text dimColor={true}>{debugMode ? "\u203B Error logs shown inline with --debug" : "\u203B Run quantum --debug to see error logs"}</Text>;
    $[60] = hasFailedClients;
    $[61] = t26;
  } else {
    t26 = $[61];
  ...
  if ($[62] === Symbol.for("react.memo_cache_sentinel")) {
    t27 = <Text dimColor={true}><Link url="https://github.com/Suryanshu-Nabheet/Quantum/blob/main/cli/README.md">Quantum CLI docs</Link>{" "}for help</Text>;
    $[62] = t27;
  } else {
    t27 = $[62];
  }
