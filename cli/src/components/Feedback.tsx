...
const GITHUB_ISSUES_REPO_URL = 'https://github.com/SuryanshuNabheet/quantum/issues';
type Props = {
      ...
      {step === 'consent' && <Box flexDirection="column">
          ...
          <Box marginTop={1}>
            <Text wrap="wrap" dimColor>
              ...
              Quantum CLI&apos;s functionality (eg. to reduce the risk of bugs
