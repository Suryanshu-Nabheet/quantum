    ...
    case "needsLogin":
      {
        ...
        if ($[16] === Symbol.for("react.memo_cache_sentinel")) {
          t9 = <Box flexDirection="column"><Text dimColor={true}>Teleport / remote sessions are not available in Quantum CLI.</Text><Text dimColor={true}>Your Claude Pro/Max subscription will be used by Quantum CLI.</Text></Box>;
          $[16] = t9;
        } else {
          t9 = $[16];
        }
