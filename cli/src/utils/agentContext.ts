 ...
 * variables instead: QUANTUM_AGENT_ID, QUANTUM_PARENT_SESSION_ID
 *
...
export type SubagentContext = {
  ...
  agentId: string
  /** The team lead's session ID (from QUANTUM_PARENT_SESSION_ID env var), undefined for main REPL subagents */
