 ...
 * rationale. Env var: QUANTUM_OAUTH_TOKEN_FILE_DESCRIPTOR.
...
export function getOAuthTokenFromFileDescriptor(): string | null {
  return getCredentialFromFd({
    envVar: 'QUANTUM_OAUTH_TOKEN_FILE_DESCRIPTOR',
