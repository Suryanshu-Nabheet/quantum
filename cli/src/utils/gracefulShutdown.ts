...
function cleanupTerminalModes(skipUnmount: boolean = false): void {
  ...
  try {
    ...
    // Respect QUANTUM_DISABLE_TERMINAL_TITLE — if the user opted out of
...
export async function gracefulShutdown(
  ...
  // overall execution via a single budget (QUANTUM_SESSIONEND_HOOKS_TIMEOUT_MS,
