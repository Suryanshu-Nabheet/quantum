...
async function doInitialize(): Promise<void> {
  ...
  // Pass QUANTUM_SKIP_PROMPT_HISTORY via -e so it's set in the initial shell environment
  //
  ...
  const result = await execTmux([
    ...
    'base',
    '-e',
    'QUANTUM_SKIP_PROMPT_HISTORY=true',
    ...(getPlatform() === 'windows'
  ...
  // Set QUANTUM_SKIP_PROMPT_HISTORY in the tmux GLOBAL environment (-g).
  ...
  // Any Quantum CLI instance spawned on this socket will inherit this env var,
