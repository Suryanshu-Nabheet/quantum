 ...
 * Structure: ~/.quantum/teams/{team_name}/inboxes/{agent_name}.json
 */
 ...
 * @param teamName - Optional team name (defaults to QUANTUM_TEAM_NAME env var or 'default')
 */
...
export type SandboxPermissionRequestMessage = {
  ...
  requestId: string
  /** Worker's QUANTUM_AGENT_ID */
  workerId: string
  /** Worker's QUANTUM_AGENT_NAME */
  workerName: string
  /** Worker's QUANTUM_AGENT_COLOR */
  workerColor?: string
 ...
 * @param teamName - Optional team name (defaults to QUANTUM_TEAM_NAME env var)
