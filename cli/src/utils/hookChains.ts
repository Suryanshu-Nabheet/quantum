...
const HOOK_CHAINS_CONFIG_ENV_PATH = 'QUANTUM_HOOK_CHAINS_CONFIG_PATH'
const HOOK_CHAINS_ENABLED_ENV = 'QUANTUM_ENABLE_HOOK_CHAINS'
const DEFAULT_HOOK_CHAINS_RELATIVE_PATH = join('.quantum', 'hook-chains.json')
