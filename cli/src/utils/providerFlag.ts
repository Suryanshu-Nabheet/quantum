 ...
 *
 * Usage:
 *   quantum --provider openai --model gpt-4o
 *   quantum --provider gemini --model gemini-2.0-flash
 *   quantum --provider mistral --model ministral-3b-latest
 *   quantum --provider ollama --model llama3.2
 *   quantum --provider anthropic   (default, no-op)
 */
 ...
 *
 * Issue #808: `quantum --model <name>` should work standalone so users can
