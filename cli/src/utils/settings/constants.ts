...
/**
 * The JSON Schema URL for Quantum CLI settings
 * You can edit the contents at https://github.com/SchemaStore/schemastore/blob/master/src/schemas/json/quantum-settings.json
 */
export const QUANTUM_SETTINGS_SCHEMA_URL =
  'https://json.schemastore.org/quantum-settings.json'
