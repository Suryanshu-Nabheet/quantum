 ...
 *
 * These helpers identify whether this Quantum CLI instance is running as a
...
export function isPlanModeRequired(): boolean {
  ...
  return isEnvTruthy(process.env.QUANTUM_PLAN_MODE_REQUIRED)
}
 ...
 * 2. Either:
 *    - Our QUANTUM_AGENT_ID matches the leadAgentId, OR
 *    - We have no QUANTUM_AGENT_ID set (backwards compat: the original
